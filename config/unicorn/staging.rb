...
listen '/tmp/staging.housingma.socket', backlog: 64
listen 8012
...
pid '/tmp/unicorn.housingma.pid'

# Production-specific settings
if env == 'production'
  # Help ensure your application will always spawn in the
  # symlinked 'current' directory that Capistrano sets up
  working_directory '/home/deployer/apps/staging.housing.ma/current'

  # feel free to point this anywhere accessible on the filesystem
  user 'deployer', 'staff'
  shared_path = '/home/deployer/apps/staging.housing.ma/shared'
...
before_fork do |server, worker|
  ...
  old_pid = '/tmp/unicorn.housingma.pid.oldbin'
